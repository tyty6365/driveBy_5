...
<head>
    ...
    <script>
        ...
        function dropClass(className) {
            $.ajax({
                url: "CompSciServlet?className=" + className,
                method: "GET",
...
<h2>
    <button class="add-button" value="jsp" name="cse">Back to Software Engineering Scheduling Page</button>
</h2>
</form>
...
<%
    ...
    ArrayList<Class> pp1 = (ArrayList<Class>)request.getAttribute("cse");
