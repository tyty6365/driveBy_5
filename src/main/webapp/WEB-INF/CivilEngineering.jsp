...
<form action = "CivilServlet" method = post>
  ...
  <div class="card-container">
    <div class="card">
      ...
      <button class="add-button" value="MATH1550_9" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="ENGL1001_41" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="CHEM1201_1" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="BIOL1001_1" name="CiviE">Add Class</button>
    </div>
  </div>
  </div>
  <div class="card-container">
    <div class="card">
      ...
      <button class="add-button" value="ASTRO1101_1" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="ART1001_1" name="CiviE">Add Class</button>
    </div>
  </div>
  ...
  <div class="card-container">
    <div class="card">
      ...
      <button class="add-button" value="CE2700_1" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="CE2450_3" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="CE3400_1" name="CiviE">Add Class</button>
    </div>
    <div class="card">
      <div class="card-header">CE 3415</div>
      <div class="card-body">Time: 1:30p - 2:30p<br>
        Days: T TH
        <br>
      </div>
      <button class="add-button" value="CE3415_1" name="CiviE">Add Class</button>
    </div>
  </div>
  <div class="Humanities">
  ...
  <div class="card-container">
    <div class="card">
      ...
      <button class="add-button" value="PHIL2020_1" name="CiviE">Add</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="CMST1061_1" name="CiviE">Add</button>
    </div>
  ...
  <div class="card-container">
    <div class="card">
      ...
      <button class="add-button" value="PHYS1201_1" name="CiviE">Add</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="PHYS2108_1" name="CiviE">Add</button>
    </div>
    <div class="card">
      ...
      <button class="add-button" value="PHYS2110_1" name="CiviE">Add</button>
    </div>
