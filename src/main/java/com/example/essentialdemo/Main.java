...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        //The code below will take in a Username and create a new com.example.essentialdemo.User object that will add all of the parameters of that user
        UserFileConvertor w = new UserFileConvertor("C:\\Users\\mimic\\IdeaProjects\\essentialDemoOff\\src\\main\\java\\com\\example\\essentialdemo\\894563332");//change when put into website
        ...
        for(int i = 0; i < w.getScheduledClasses().size(); i++){
            ...
            Course a = new Course("C:\\Users\\willc\\IdeaProjects\\com.example.essentialdemo.User\\src\\"+testClass);
        ...
        Course csc4040 = new Course("C:\\Users\\mimic\\IdeaProjects\\essentialDemoOff\\src\\main\\java\\"+"CSC4040");
