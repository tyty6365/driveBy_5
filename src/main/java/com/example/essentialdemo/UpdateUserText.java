...
public class UpdateUserText {
    public static void updateTextFile(String fileName, String newClass) {
        try {
            ...
            reader.close();
            String newContent = oldContent.replaceAll("ScheduledClasses:\\s*(.*)", "ScheduledClasses:$1,"+newClass);            File newFile = new File("C:\\Users\\mimic\\IdeaProjects\\essentialDemoOff\\src\\main\\java\\com\\example\\essentialdemo\\" + fileName);
